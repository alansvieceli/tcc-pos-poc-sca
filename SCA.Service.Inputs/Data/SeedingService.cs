...
namespace SCA.Service.Inputs.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Insumo i1 = new Insumo { Id = 1, Descricao = "Insumo 1", Marca = m5, Tipo = t1, Status = InsumosStatus.Ativo };
            Insumo i2 = new Insumo { Id = 2, Descricao = "Insumo 2", Marca = m5, Tipo = t2, Status = InsumosStatus.Ativo };
            Insumo i3 = new Insumo { Id = 3, Descricao = "Insumo 3", Marca = m1, Tipo = t4, Status = InsumosStatus.Ativo };
            Insumo i4 = new Insumo { Id = 4, Descricao = "Insumo 4", Marca = m7, Tipo = t6, Status = InsumosStatus.Inativo };
