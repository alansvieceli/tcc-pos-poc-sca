...
namespace SCA.Service.Monitoring.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            SensorHistorico sh4 = new SensorHistorico { Id = 4, Sensor = s2, Data = new DateTime(2019, 11, 14, 10, 19, 44), Status = SensorStatus.Amarelo };
            SensorHistorico sh5 = new SensorHistorico { Id = 5, Sensor = s4, Data = new DateTime(2019, 11, 15, 11, 44, 01), Status = SensorStatus.Amarelo };
            SensorHistorico sh6 = new SensorHistorico { Id = 6, Sensor = s4, Data = new DateTime(2019, 11, 15, 11, 47, 9), Status = SensorStatus.Amarelo };
            SensorHistorico sh7 = new SensorHistorico { Id = 7, Sensor = s4, Data = new DateTime(2019, 11, 15, 12, 04, 19), Status = SensorStatus.Verde };
            ...
            SensorHistorico sh16 = new SensorHistorico { Id = 16, Sensor = s10, Data = new DateTime(2019, 11, 14, 9, 15, 25), Status = SensorStatus.Verde };
            ...
            SensorHistorico sh18 = new SensorHistorico { Id = 18, Sensor = s11, Data = new DateTime(2019, 11, 13, 9, 15, 25), Status = SensorStatus.Verde };
            ...
            SensorHistorico sh22 = new SensorHistorico { Id = 22, Sensor = s13, Data = new DateTime(2019, 11, 13, 9, 27, 25), Status = SensorStatus.Verde };
            ...
            SensorHistorico sh24 = new SensorHistorico { Id = 24, Sensor = s14, Data = new DateTime(2019, 11, 13, 9, 22, 25), Status = SensorStatus.Verde };
            ...
            SensorHistorico sh32 = new SensorHistorico { Id = 32, Sensor = s18, Data = new DateTime(2019, 11, 17, 9, 00, 25), Status = SensorStatus.Verde };
            ...
            SensorHistorico sh34 = new SensorHistorico { Id = 34, Sensor = s19, Data = new DateTime(2019, 11, 17, 9, 00, 25), Status = SensorStatus.Verde };
            ...
            SensorHistorico sh38 = new SensorHistorico { Id = 38, Sensor = s25, Data = new DateTime(2019, 11, 15, 17, 00, 25), Status = SensorStatus.Verde };
            ...
            SensorHistorico sh40 = new SensorHistorico { Id = 40, Sensor = s27, Data = new DateTime(2019, 11, 15, 17, 00, 25), Status = SensorStatus.Verde };
            ...
            SensorHistorico sh42 = new SensorHistorico { Id = 42, Sensor = s28, Data = new DateTime(2019, 11, 15, 17, 00, 25), Status = SensorStatus.Verde };
            SensorHistorico sh43 = new SensorHistorico { Id = 43, Sensor = s28, Data = new DateTime(2019, 11, 15, 18, 19, 44), Status = SensorStatus.Verde };
            SensorHistorico sh44 = new SensorHistorico { Id = 44, Sensor = s29, Data = new DateTime(2019, 11, 13, 17, 00, 25), Status = SensorStatus.Verde };
            SensorHistorico sh45 = new SensorHistorico { Id = 45, Sensor = s29, Data = new DateTime(2019, 11, 13, 18, 19, 44), Status = SensorStatus.Verde };
            SensorHistorico sh46 = new SensorHistorico { Id = 46, Sensor = s30, Data = new DateTime(2019, 11, 13, 17, 00, 25), Status = SensorStatus.Verde };
            SensorHistorico sh47 = new SensorHistorico { Id = 47, Sensor = s30, Data = new DateTime(2019, 11, 13, 18, 19, 44), Status = SensorStatus.Verde };
